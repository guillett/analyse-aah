...
function Graphique() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_2__["useEffect"])(function () {
    ...
    fetchData(source).then(function (payload) {
      ...
      svg.append("g").selectAll("g").data(series).join("g").attr("fill", function (d) {
        ...
        return y(d[0]) - y(d[1]);
      }).attr("width", x.bandwidth()).on("mouseover", function (_, index) {//setCurrentValues(data[index])
      });
  ...
  return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
    ...
    return react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("div", {
      ...
      __self: this
    }, n, react__WEBPACK_IMPORTED_MODULE_2___default.a.createElement("span", {
      style: {
        color: colors(n)
      },
      __source: {
...
//# sourceMappingURL=graphique.js.d1a79923550bba90299e.hot-update.js.map