...
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony import */ var _babel_runtime_corejs2_core_js_parse_int__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime-corejs2/core-js/parse-int */ "./node_modules/@babel/runtime-corejs2/core-js/parse-int.js");
...
function Graphique() {
  ...
  var _useState15 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(''),
      ...
      jsonData = _useState16[0],
      setJsonData = _useState16[1];
  ...
  var _useState17 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(0),
      ...
      abat_forf = _useState18[0],
      setAbat_forf = _useState18[1];
  ...
  var _useState19 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(0),
      ...
      abat_forf_enf = _useState20[0],
      setAbat_forf_enf = _useState20[1];

  var _useState21 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(0),
      _useState22 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_useState21, 2),
      prog_abat = _useState22[0],
      setProg_abat = _useState22[1];

  var _useState23 = Object(react__WEBPACK_IMPORTED_MODULE_4__["useState"])(false),
      _useState24 = Object(_babel_runtime_corejs2_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_2__["default"])(_useState23, 2),
      deconj = _useState24[0],
      setDeconj = _useState24[1];
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    ...
    fetchData(source).then(function (payload) {
      setPayload(payload);
      setJsonData(_babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(payload));
  ...
  var to64 = typeof btoa == "undefined" ? function (e) {
    return e && Buffer.from(e).toString('base64');
  } : btoa;
  return react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("div", {
    ...
    __self: this
  }, "Lien"), " ", jsonData, " ", react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("a", {
    download: "data.json",
    href: "data:application/json;base64," + to64(jsonData),
    __source: {
      fileName: _jsxFileName,
      lineNumber: 256
    },
    __self: this
  }, "Donn\xE9es")), react__WEBPACK_IMPORTED_MODULE_4___default.a.createElement("div", {
    style: {
      height: '400px',
      width: '100%'
    },
...
//# sourceMappingURL=graphique.js.ec8c79c1b54e3a526fb4.hot-update.js.map